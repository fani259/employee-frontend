...
const Login = () => {
    ...
    const { login } = useAuth();  // ✅ Use useAuth() correctly at the top
    ...
    return (
        <div className='flex flex-col items-center h-screen justify-center bg-gradient-to-b from-teal-600 from-50% to-gray-100% to-50% space-y-6'>
            <h2 className="font-pacifico text-4xl text-white">
            ...
            <div className='border shadow p-6 w-80 bg-white'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='mb-4'>
                        <button type='submit' className='w-full cursor-pointer bg-teal-600 text-white py-2'>Login</button>
                    </div>
                </form>
            </div>
        </div>
