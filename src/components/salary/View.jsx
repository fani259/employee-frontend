...
const View = () => {
    ...
    //             },
    //         });
    //         console.log("Fetched Salaries:", response.data.salary);
    ...
    const fetchSalaries = async () => {
        try {
            ...
            console.log("Fetched Salaries API Response:", response.data); // ✅ Debugging

            if (response.data.success) {
                setSalaries(response.data.salary || []); // ✅ Ensure it's an array
                setFilteredSalaries(response.data.salary || []);
            } else {
                console.error("API request was not successful.");
            }
        } catch (error) {
            console.error("Error fetching salaries:", error.response?.data || error);
            alert("Failed to fetch salaries");
        }
    };
