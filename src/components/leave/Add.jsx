            ...
            <form onSubmit={handleSubmit}>
                <div className='flex flex-col space-y-4 '>
                    ...
                    <div>
                        ...
                        <textarea name='reason' placeholder='Reason' onChange={handleChange} className='w-full border border-gray-300' required />
                    </div>
                </div>
                <button type='submit' className='w-full mt-6 bg-teal-600 hover:bg-teal-600 text-white font-bold py-2 px-4 rounded-md' >Add Salary</button>
            </form>
        </div>
    );
}
